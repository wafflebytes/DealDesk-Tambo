        ...
        <div className="h-full flex items-center justify-center p-4 sm:p-8">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center text-center space-y-8">
                    <div className="w-24 h-24 rounded-3xl bg-white shadow-2xl flex items-center justify-center relative group-hover:scale-105 transition-transform duration-500 ring-8 ring-white sm:w-32 sm:h-32">
                        <div className="absolute inset-0 bg-gradient-to-br from-white to-[#f4fafa] rounded-3xl" />
                        <UploadCloud className="w-12 h-12 text-stone-400 group-hover:text-[#20808D] transition-colors duration-500 relative z-10 sm:w-14 sm:h-14" />
                    ...
                    <div className="space-y-3 max-w-sm">
                        <h3 className="font-serif text-3xl text-stone-800 font-medium tracking-tight group-hover:text-[#0d3d43] transition-colors duration-500 sm:text-4xl">Upload Contract</h3>
                        <p className="text-base text-stone-500 leading-relaxed font-medium sm:text-lg">

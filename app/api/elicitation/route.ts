...
**USE 'v1' (Choice Card)** when the user's request is HIGH-LEVEL or AMBIGUOUS, meaning they haven't specified WHICH tool/analysis they want.
  ...
  - The options should route to specific GenUI components: "Analyze Risk", "Refine a Clause", "Extract Obligations", "Clarify Definitions".
  - v1 options have: label (short, like "Analyze Risk"), value (like "risk_analysis").

**USE 'v2' (Form Card)** when the user has ALREADY CHOSEN a specific action/tool (like "refine the clause") and you need to collect PARAMETERS before executing.
  - Examples: "refine the clause", "negotiate liability", "adjust the cap"

...
export default function LandingPage() {
  return (
    <div className="relative min-h-[100svh] overflow-hidden bg-gradient-to-br from-[#f4fafa] via-white to-[#edf3f3]">
      {/* Atmosphere */}
      ...
      <main className="relative mx-auto flex min-h-[100svh] w-full max-w-6xl flex-col justify-center px-4 py-10 sm:px-6 sm:py-14">
        {/* Mark */}
        <div className="flex items-center gap-3 animate-in fade-in duration-500">
          <div className="knob-skeu flex h-10 w-10 items-center justify-center rounded-2xl shadow-sm sm:h-12 sm:w-12">
            <Scale
              className="relative z-10 h-5 w-5 text-[#165a63] drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)] sm:h-6 sm:w-6"
              strokeWidth={1.8}
            />
          </div>
          ...
          <div className="leading-none">
            <div
              className="font-serif text-[24px] tracking-[-0.04em] text-[#0d3d43] sm:text-[28px]"
        ...
        <div className="mt-10 grid w-full grid-cols-1 gap-10 md:grid-cols-[1.05fr_0.95fr] md:items-center">
          ...
          <section className="animate-in fade-in slide-in-from-bottom-2 duration-700">
            <h1
              className="font-serif text-[40px] leading-[1.02] tracking-[-0.05em] text-stone-900 sm:text-[46px]"
              style={{ fontWeight: 550 }}
            >
            ...
            <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-stone-600">
              Drop in an agreement and work it like a craft: risks surfaced, clauses refined, definitions clarified —
          ...
          <section className="animate-in fade-in slide-in-from-bottom-2 duration-700 delay-150">
            <div className="relative">
              ...
              <div className="card-skeu relative rounded-[28px] border border-white/70 bg-white/80 p-4 shadow-xl sm:p-6">
                ...
                <div className="mt-5 space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                    ...
                    <div className="card-skeu rounded-2xl p-4">
                      ...
                      <div className="mt-1 text-xs text-stone-500">negotiable</div>
                    </div>
                    <div className="card-skeu rounded-2xl p-4">
                      <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-stone-500">
                        Terms

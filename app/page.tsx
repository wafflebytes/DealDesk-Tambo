      ...
      <main className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center px-6 py-14">
        ...
        <div className="flex items-center gap-3 animate-in fade-in duration-500">
          ...
          <div className="leading-none">
            <div
              className="font-serif text-[28px] tracking-[-0.04em] text-[#0d3d43]"
        ...
        <div className="mt-10 grid w-full grid-cols-1 gap-10 md:grid-cols-[1.05fr_0.95fr] md:items-center">
          ...
          <section className="animate-in fade-in slide-in-from-bottom-2 duration-700">
            <h1
              className="font-serif text-[46px] leading-[1.02] tracking-[-0.05em] text-stone-900"
              style={{ fontWeight: 550 }}
            >
          ...
          <section className="animate-in fade-in slide-in-from-bottom-2 duration-700 delay-150">
            <div className="relative">
              ...
              <div className="card-skeu relative rounded-[28px] border border-white/70 bg-white/80 p-6 shadow-xl">
